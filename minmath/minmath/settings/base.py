"""
Django settings for minmath project.
...
MIDDLEWARE = [
    'minmath.middleware.DatabaseErrorMiddleware',
...
WSGI_APPLICATION = 'minmath.wsgi.application'
...
# added for login/logout redirects
LOGIN_REDIRECT_URL = "/"
LOGOUT_REDIRECT_URL = "/"

# added for site account user
